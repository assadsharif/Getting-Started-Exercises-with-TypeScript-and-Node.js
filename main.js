...
var message_one = "My favorite number is: " + favorite_Number;
console.log(message_one); // Prints: My favorite number is: 7
// 11: Names: Store the names of a few of your friends in a array called names. Print each person’s name by accessing each element in the list, one at a time.
var names = ["Ahmed", "Asif", "Zeeshan", "Hafiz"];
...
var transportation = ["car", "motorcycle", "cycle", "byke"];
for (var i = 0; i < transportation.length; i++) {
  console.log("I would like to own a " + transportation[i] + ".");
}
// 14: Guest List: If you could invite anyone, living or deceased, to dinner, who would you invite? Make a list that includes at least three people you’d like to invite to dinner. Then use your list to print a message to each person, inviting them to dinner.
var guestList = ["Ahmed", "Asif", "Zeeshan"];
...
var guestList = ["Asif", "Ahmed", "Zeeshan"];
console.log("Original Guest List:");
for (var i = 0; i < guestList.length; i++) {
  console.log(guestList[i]);
}
var indexToRemove = 1;
var newGuest = "Hafiz";
var cancelledGuest = guestList.splice(indexToRemove, 1, newGuest)[0];
console.log("\nUpdated Guest List:");
for (var i = 0; i < guestList.length; i++) {
  console.log(guestList[i]);
}
...
var guestList = ["Asif", "Ahmed", "Zeeshan", "Anwar", "Zaheer", "Kamran"];
console.log(
...
var placesToVisit = ["Pakistan", "Italy", "Australia", "Canada", "Brazil"];
...
var alien_color_yellow = "yellow"; // or 'red'
// Check if the alien's color is green
if (alien_color === "green") {
  console.log("Congratulations! You just earned 5 points.");
}
...
var usernames = ["admin", "john", "emma", "alex", "sophia"];
...
var usernames = ["Ahmed", "Asif", "Zeeshan", "Hafiz", "Sophia"];
...
var current_users = ["john", "emma", "alex", "sophia", "mike"];
var new_users = ["emily", "mike", "sarah", "john", "nick"];
...
for (var i = 0; i < new_users.length; i++) {
  ...
  var new_user_lower = new_users[i].toLowerCase();
...
function make_shirt(size, message) {
  console.log(
    "You have ordered a "
      .concat(size, ' T-shirt with the message: "')
      .concat(message, '".')
  );
}
...
var magicians = ["Asad", "Ahmed", "Asif", "Zeeshan"];
